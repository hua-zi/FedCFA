...
from ...utils.dataset.partition import CIFAR10Partitioner, CIFAR100Partitioner,VisionPartitioner, MNISTPartitioner, FMNISTPartitioner
...
class LPartitionedFMNIST(PartitionedFMNIST):
    def __init__(self,
                 root,
                 path,
                 dataname,
